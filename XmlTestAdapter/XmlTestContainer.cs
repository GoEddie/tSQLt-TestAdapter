...
{
    public class XmlTestContainer:ITestContainer
    {
        private ITestContainerDiscoverer discoverer;
        public XmlTestContainer(ITestContainerDiscoverer discoverer, string source, Uri executorUri)
            :this(discoverer, source, executorUri, Enumerable.Empty<Guid>())
        {}

        public XmlTestContainer(ITestContainerDiscoverer discoverer, string source, Uri executorUri, IEnumerable<Guid> debugEngines)
        {
            this.Source = source;
        ...
        private XmlTestContainer(XmlTestContainer copy)
        ...
        {
            var testContainer = other as XmlTestContainer;
        ...
        {
            return new XmlTestContainer(this);
        }
    }
}
