...
namespace tSQLtTestAdapter
{
    ...
    public class XmlTestContainerDiscoverer : ITestContainerDiscoverer
    {
        ...
        protected string FileExtension { get { return ".xml"; } }
        ...
        private void AddTestContainerIfTestFile(string file)
        {
            ...
            if (isTestFile)
            {
                var container = new XmlTestContainer(this, file, ExecutorUri);
