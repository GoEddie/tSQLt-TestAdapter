...
", new List<TestClass>());
        ...
        public void FindsSchema()
        {
            ...
            var result =
            scanner.ScanCode("--select 100\r\nGO\r\ncreate      /*AAAAAAAA*/ schema [my_schema];", new List<TestClass>());
        ...
        public void FindsTestProcedure()
        {
            ...
            var result =
            scanner.ScanCode("--select 100\r\nGO\r\ncreate    procedure [test hello there] as select 1;", new List<TestClass>());
        ...
        public void FindsDoesNotFindNonTestProcedure()
        {
            ...
            var result =
            scanner.ScanCode("--select 100\r\nGO\r\ncreate    procedure [blah hello there] as select 1;", new List<TestClass>());
